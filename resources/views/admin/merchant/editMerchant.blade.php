<!---------Modal----------->
<form action="{{route('updateMerchant')}}" method="POST">
    @csrf
    <div class="modal-header">
        <h5 class="modal-title" id="editMerchant">Edit Merchant</h5>
        <button
            type="button"
            class="btn-close"
    ...
    <div class="modal-body">
        <div class="row mx-3">
            <div class="mb-3 col-md-6">
                <label for="userName" class="form-label">Merchant Name</label>
