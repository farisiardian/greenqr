...
@section('content')
    ...
    <section class="mb-4 pb-5 d-none d-xl-block ">
		...
		<div class="card-image mt-5" style="width:100%;padding-left:100px;padding-right:100px">
			<div class="d-flex justify-content-between align-items-center">
				<h2 class="d-none d-xl-block main-title"></h2>
  ...
  <div class="card bg-light">
    <div class="card-body">
      <h4 style="color:#274439">Filter</h4>
      <div class="form-group">
        <b><label style="color:#1FA33D" for="priceRange">Price</label></b>
        <div>
          <label>
            <input type="checkbox" class="price-filter" value="0-10"> RM0 - RM50
          </label>
        </div>
        <div>
          <label>
            <input type="checkbox" class="price-filter" value="10-20"> RM51 - RM100
          </label>
        </div>
        <div>
          <label>
            <input type="checkbox" class="price-filter" value="20-30"> RM101 - RM500
          </label>
        </div>
		<div>
          <label>
            <input type="checkbox" class="price-filter" value="20-30"> > RM500
          </label>
        </div>
      </div>
      <div class="form-group">
        <label style="color:#1FA33D" for="ratingRange">Rating</label>
        <div>
          <label>
            <input type="checkbox" class="rating-filter" value="4"> 1 Stars
          </label>
        </div>
        <div>
          <label>
            <input type="checkbox" class="rating-filter" value="3"> 2 Stars
          </label>
        </div>
        <div>
          <label>
            <input type="checkbox" class="rating-filter" value="2"> 3 Stars
          </label>
        </div>
		<div>
          <label>
            <input type="checkbox" class="rating-filter" value="2"> 4 Stars
          </label>
        </div>
		<div>
          <label>
            <input type="checkbox" class="rating-filter" value="2"> 5 Stars
          </label>
        </div>
      </div>
  ...
  @foreach($listProductsBasedoncategory as $product_list)
    <div class="col-sm-4 col-md-4 col-lg-4" style="padding-bottom: 20px;">
  ...
  @endforeach
    ...
    <section class="d-block d-sm-none ">
        ...
        <div class="card-image" style="width:100%;height:556px">
				<img class="image" src="{{asset('img/banner-m.png')}}" width="100" alt="" >
				<div class="text-blockm">
					<h1 class="main-m">One Stop Health Screening Service.</h4>
					<p class="contents-m my-5">Keep track of your health, plus boost lifespan and well-being today with our comprehensive screening.</p>
					<div class="card-load-more">
						<a class="button" href="http://healthee.com.my/shop.show/59">Learn More</a>
					</div>
				</div>	
			</div>
    </section>
...
{{--                <a href="http://206.189.144.207/shop?id=7">View All</a>--}}
    ...
    <section class="d-none d-xl-block ">
        <div style="width:100%;padding:60px 100px">
            <div class="d-flex justify-content-between align-items-center">
                <h2  class="d-none d-xl-block main-title">Shop By Brand</h2>
				<a href="{{route('allshops')}}">View All</a>
            </div>
			<div>
    ...
    <section class=" d-block d-sm-none mt-5">
        <div class="card-image" style="width:100%;padding:0 30px">
			<div class="d-flex justify-content-between align-items-center">
                <h4 class="title mb-0" style="font-size:18px">Shop by Brands</h4>
				<a href="{{route('allshops')}}">View All</a>
			</div>
...
{{--    Desktop View--}}
    <!--section class=" d-none d-xl-block" id="target-section">
        <div style="width:100%;padding:60px 100px">
            <div class="d-flex justify-content-between align-items-center">
                <h2  class="d-none d-xl-block main-title"> Todays Best Deals For You </h2>
				<a href="{{route('allproduct')}}">Shop All</a>
            </div>
			<div class="tab-content px-0" id="myTabContent">
				<div class="tab-pane fade show active" id="lists" role="tabpanel" aria-labelledby="lists">
...
{{--Mobile View--}}
    <section class="section-categories d-block d-sm-none mt-5">
        <div class="card-image" style="width:100%;padding:0 30px">
			<div class="d-flex justify-content-between align-items-center">
                <h4 class="title mb-0" style="font-size:18px">Todays Best Deals For You test</h4>
				<a href="{{route('allproduct_mobile')}}">Shop All</a>
			</div>
			<div class="wrapper">
			...
			@endforeach
				...
				<div class="owl-carousel owl-theme mt-3" id="justforyou">
					@foreach($listProductsBasedoncategory as $product_list)
...
@section('script')
	...
	<script>
	// Get the price filter checkboxes
		const priceCheckboxes = document.querySelectorAll('.price-filter');

		// Get the rating filter checkboxes
