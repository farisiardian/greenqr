...
class MessagesController extends Controller
{
	...
	public function send(Request $request)
    {
        ...
        if (!$error->status) {
            ...
            // Check if the authenticated user and recipient have different roles
            if (Auth::user()->role != $recipientUser->role) {
                ...
                $error->status = 1;
                $error->message = "You cannot send a message to a user with the same role.";
            }
        }
    ...
    public function sendTestingPrevious(Request $request)
    {
        // default variables
        $error = (object)[
            'status' => 0,
