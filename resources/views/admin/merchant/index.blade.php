                            ...
                            <form class="form-sample form-row" method="get" action="{{route('merchant.index')}}">
                                <div class="row">
                                    ...
                                    <div class="mt-4 d-flex justify-content-end">
                                        ...
                                        <a href="{{route('merchant.index')}}" type="button" class="btn btn-danger me-2">Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">Merchant Status</th>
                                            <th>Actions</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <tr>
                                            <td>
												<div>
													<img src="{{asset('storage/'.$user->profile_image)}}" width="50px" class="me-2 rounded-circle border"/>
												</div>
												<div class="mt-2">
                                            ...
                                            <td>
                                                    {{QrCode::size(120)->generate('http://206.189.144.207/shop/'.$user->id)}}
                                            </td>
{{--                                            <img src="{{(QrCode::size(50)->generate('Export Rohila')->route('shop.show',['id'=>$user->id]))}} ">--}}
                                            <td>
                                                <div>
