        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modalEditSolicitor">Prepare Delivery</h4>
                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                                                            @if($orders[0]->image()->first())
                                                                <img
                                                                    src="{{asset('storage/'.$orders[0]->image()->first()->image)}}"
                                                            ...
                                                            @else
                                                                <img
                                                                    ...
                                                                    width="100"/>
                                                            @endif
                                                            <b>{{$orders[0]->prodName}} - <br>{{$orders[0]->userName}} - {{$orders[0]->variationName}}</b><span>x{{$orders->count('transaction_id')}}</span></div>
...
{{--<td>--}}
{{--    <a href="#" data-toggle="modal" data-target="#viewDetail" data-id="{{$orders[0]->transaction_id}}" class="viewDetail-modals dropdown-item">View</a>--}}
{{--</td>--}}
</tr>
@endforeach
{{--                                                <tr>--}}
...
<script>
        ...
        $(document).on("click",".viewDetail-modals", function(e){
            // alert('ok');
            var eventId = $(this).data('id');
            var url = '{{route('/')}}' + '/viewOrder/' + eventId;
            alert(eventId);
            $.ajax({
                type:'GET',
                url:url ,
