...
<head>
    ...
    <title>Dashboard | GreenQr </title>
    <meta name="description" content="" />
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('admin/assets/img/favicon/greenqr-icon.png')}}" />
    <!-- Fonts -->
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
                <a href="{{route('/')}}" class="app-brand-link">
                    ...
                    <img src="{{asset('admin/assets/img/favicon/greenQR_brand.png')}}" alt class="w-px-150 h-auto " />
            ...
            <ul class="menu-inner py-1">
                ...
                @if(Auth::user()->role == 'admin')
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{route('allstaff.index')}}" class="menu-link">  <!--web/function dlm controller route(' route_dari_web.nama_function ') }}-->
                                    <div data-i18n="Account">All Staff</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{route('addstaff')}}" class="menu-link">  <!-- klu ada sub menu baru, just guna nama dlm Route::get('/addstaff',..) ni, "addstaff"-->
                                    <div data-i18n="Notifications">Add Staff</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar avatar-online">
                                                    @if(Auth::user()->profile_image != null)
														<img src="{{asset('storage/'.Auth::user()->profile_image)}}" alt="user-avatar" class="w-px-40 h-auto rounded-circle"/>
													@else
														<img src="{{asset('admin/assets/img/avatars/3.png')}}" alt="user-avatar" class="w-px-40 h-auto rounded-circle" />
													@endif
                                                </div>
