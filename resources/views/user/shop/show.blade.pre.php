            ...
            <div class="row s_product_inner">
                <div class="col-lg-6 d-flex ml-2 col-sm-4">
                    ...
                    <div class="col-sm-12 col-lg-6 mt-3">
                        ...
                        <p class="text-white"><i class="fas fa-box mr-3"></i>{{count($product)}} Products</p>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card text-center card-product">
                                    ...
                                    <div class="card-body">
                                        <p style="color: rgba(222,222,222,0.84)">{{$products->mainCategory()->first() ? $products->mainCategory()->first()->name :''}}</p>
                                        <h4 class="card-product__title"><a href="#" class="hover-black text-white text-truncate">{{$products->name}}</a></h4>
                                        <p class="card-product__price text-white">RM {{$products->list_price_on_store}}</p>
                                    </div>
                                </div>
                            </div>
                            @endforeach
